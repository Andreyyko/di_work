        ...
        <div>
          ...
          <div className="flex flex-col">
            <div className="flex flex-row gap-5">
              ...
              <p className="heading-4 md:w-[70%] lg:w-[47%] mt-10 lg:mt-12">
                Усі тексти, інструкції, формулювання, структура методик, опис
                процедур, терапевтичні інтервенції та формати застосування є
                результатом авторської адаптації та науково-методичної розробки
                Андрейко, Б. В.
              </p>
            </div>
            <div className="flex flex-row gap-5">
