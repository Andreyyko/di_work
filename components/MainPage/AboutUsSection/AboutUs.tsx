  ...
  return (
    <section className="w-full pb-responsive">
      <div className="flex flex-col md:flex-row items-center md:justify-between md:mb-[50px]">
        ...
        <p className="heading-bg sm:whitespace-nowrap translate-y-5 z-50 sm:hidden">
      ...
      <div className="flex flex-col items-start sm:items-center md:flex-row justify-between">
        ...
        <div className="flex flex-col sm:flex-row sm:w-[75%] md:w-full">
          ...
          <span className="heading-5 -translate-x-4 items-end lg:w-[26%] 2xl:w-[25%] text-left hidden lg:flex">
          ...
          <div className="flex flex-col justify-end sm:-ml-4 md:ml-0 lg:w-[355px] xl:w-[420px]">
            ...
            <p className="heading-4 mb-[30px] md:mb-0 text-left">
