  ...
  return (
    <div className="flex flex-col md:flex-row gap-5 lg:gap-20 items-end md:pb-70 pb-[150px]">
      <Image
        ...
        alt="flower"
        className="absolute z-100 xl:bottom-[60.5%] 2xl:bottom-[62%] lg:bottom-[58.5%] xl:w-fit lg:w-[70%] lg:left-0 right-0 lg:scale-x-100 scale-x-[-1] md:bottom-[65%] md:w-[60%] bottom-[71%] translate-x-30 md:translate-x-0 w-[90%]"
      />
