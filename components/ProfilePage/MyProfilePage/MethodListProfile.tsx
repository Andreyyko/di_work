...
export default function MethodsListProfile() {
  ...
  const visibleItems: MethodCardType[] = useMemo(() => {
    ...
    for (const rel of relations) {
      ...
      console.log("[MyProfile] relation -> slug:", {
        relation: rel,
        section,
        slug,
      });
      ...
      console.log("[MyProfile] slug -> meta:", slug, meta);
      if (!meta) continue;
      ...
      <div className="w-full flex justify-center lg:justify-end">
        <div className="flex flex-col items-center lg:items-start gap-5 w-full lg:w-[71%]">
          ...
          <h4 className="heading-4 w-full lg:w-[80%]">
            Тут відображені розділи методик, які ви придбали. Ви можете з них
            переходити до методик та матеріалів.
          </h4>
