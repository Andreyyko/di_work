        ...
        <div className="flex flex-col w-full lg:w-[50%] gap-5">
          <SectionsTextsCustom
            ...
            list={[
              ...
              "Для дітей з особливими освітніми потребами, зокрема дітей з нейророзвитковими розладами, такими як розлади спектра аутизму (РАС, ASD) та синдром дефіциту уваги з гіперактивністю (СДУГ, ADHD) відповідно до Міжнародної класифікації хвороб 11-го перегляду (МКХ-11, ICD-11).",
              "Методики підходять для роботи психологів, логопедів, корекційних педагогів, дефектологів, педагогів інклюзивної освіти та батьків, які шукають ефективні вправи для розвитку мовлення, комунікації та психічних процесів у дітей."
            ]}
          />
          <TwoFrameButton
            variant="one"
