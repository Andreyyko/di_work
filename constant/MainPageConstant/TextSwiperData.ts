     ...
     slides :[
        {
          title: "ДЛЯ СЕБЕ",
          description:
            "Якщо ви відчуваєте втрату ресурсу, життєздатності, мотивації, втому, стрес та тривогу. Пізнання себе, відкриття самоцінності, унікальності і знаходження сенсу. Досягнення цілей через призму власних ресурсів.Багато методик та інтервенцій, використовується як інструмент самодопомоги в кризових ситуаціях, в роботі з тривогою та стресом, у пізнанні власної особистості.",
        },
        {
